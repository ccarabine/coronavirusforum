...
The live link is https://ccarabine.github.io/coronavirusforum/
...
| Create project |  `django-admin startproject coronavirus.`|
| Create App |  `python3 manage.py startapp forum`|
...
| Step | Code |
| ------ | ------ |
| Create an account at heroku.com | Create new app - App name is "coronavirusforum"  and Location is "Europe" and click on create an app|
...
![Policy rules](docs/images/deployment/aws_1.png)
</details>
...
![screen shot of add statement](docs/images/deployment/aws_2.png)
</details>
...
|Add Heroku hostname to ALLOWED_HOSTS|<code>ALLOWED_HOSTS = ["coronavirusforum.herokuapp.com", "localhost"]</code>|
...
|Create a Procfile on the top level directory|Add <code>web: gunicorn coronavirus.wsgi</code>|
...
https://github.com/ccarabine/coronavirusforum.git. This will clone your repository
...
- Type `git clone` and then paste the URL  `https://github.com/ccarabine/coronavirusforum.git` Press Enter. Your local clone will be created
...
<code>os.environ.setdefault("SECRET_KEY", TO BE ADDED BY USER)<br>
...
os.environ.setdefault("EMAIL_HOST_USER", TO BE ADDED BY USER)<br>
os.environ.setdefault("EMAIL_HOST_PASS", TO BE ADDED BY USER)<br>
os.environ.setdefault("USE_AWS", TO BE ADDED BY USER)<br>
os.environ.setdefault("DATABASE_URL", TO BE ADDED BY USER)</code><br>
